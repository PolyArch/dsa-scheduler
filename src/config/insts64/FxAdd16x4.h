...
/*
printf("FxAdd16x4 A: %f %f %f %f\n", FIX_TO_DOUBLE(a0), FIX_TO_DOUBLE(a1),
FIX_TO_DOUBLE(a2), FIX_TO_DOUBLE(a3)); for (int i = 0; i < 64; ++i) putchar(ops[0] >> i &
1 ? '0' : '1'); puts(""); printf("FxAdd16x4 B: %f %f %f %f\n", FIX_TO_DOUBLE(b0),
FIX_TO_DOUBLE(b1), FIX_TO_DOUBLE(b2), FIX_TO_DOUBLE(b3)); for (int i = 0; i < 64; ++i)
putchar(ops[1] >> i & 1 ? '0' : '1'); puts("");
*/
a0 = FIX_ADD(a0, b0);
a1 = FIX_ADD(a1, b1);
a2 = FIX_ADD(a2, b2);
...
FIX_TO_DOUBLE(a2), FIX_TO_DOUBLE(a3)); for (int i = 0; i < 64; ++i) putchar(res >> i & 1 ?
'0' : '1'); puts("");
*/
